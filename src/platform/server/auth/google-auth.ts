 ...
 * Request-shaped deployment helpers in `@/platform/server/env/environment`.
 */
 ...
 * better-auth socialProviders registration (src/platform/server/auth/config.ts) and the
